...
export const dateFormatChange =(val) =>{
...
export const dateFormatChange1 =(val) =>{
    let date        = new Date(val),
    month1 = '' + (date.getMonth() + 1),
    day1 = '' + date.getDate(),
    year1 = date.getFullYear();
    ...
    let current_date = [day1, month1, year1].join('-');
    return  current_date ;
}
export const dateFormatChange2 =(val) =>{
    let date        = new Date(val),
    month1 = '' + (date.getMonth() + 1),
    day1 = '' + date.getDate(),
    year1 = date.getFullYear();
    ...
    let current_date = [year1, month1,day1 ].join('-');
    return  `${current_date} 00:00:00` ;
}

export const dateFormatChange3 =(val) =>{
    let date        = new Date(val),
    month1 = '' + (date.getMonth() + 1),
    day1 = '' + date.getDate(),
    year1 = date.getFullYear();
